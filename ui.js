    ...
    Motor.iniciarTemporizador(30,
      ...
      function () {
        ...
        timeUpBanner.innerHTML =
          ...
          '<button class="ctrl-btn fail" id="tuFail">❌ Fallo</button>' +
          '</div>';
        document.getElementById('tuOk').onclick = function () {
          timeUpBanner.style.display = 'none';
          evaluar(true, retoActual, equipoRetoActual, 10);
        };
        document.getElementById('tuFail').onclick = function () {
          timeUpBanner.style.display = 'none';
          evaluar(false, retoActual, equipoRetoActual, 0);
        };
      }
    );
